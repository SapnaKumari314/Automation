...
public class TOUC3330_RunOverrideScreenClosure extends BaseTestClass{
	...
	@Test(
			description="TOUC-3330: CCSS-RRT-Run Details: Override Runs screen is closed when another bus is searched",
	...
	public void Test_TOUC_3330() throws InterruptedException {
		...
		//Click Run Override button
		rrtPage.clickOverrideRun();

		//Verify that Run Override screen is displayed
		sAssert.assertTrue(rrtPage.CCSS_RunOverride_Screen.isDisplayed(), "Run Override Screen display on clicking Override button from Run Details");
		...
		sAssert.assertFalse(rrtPage.isElementPresent(rrtPage.CCSS_RunOverride_Screen), "Run Override Screen closure when another Bus is searched");
		...
		//Verify that Run Override Screen is closed
		sAssert.assertFalse(rrtPage.isElementPresent(rrtPage.CCSS_RunOverride_Screen), "Run Override Screen closure when Garage is switched");
