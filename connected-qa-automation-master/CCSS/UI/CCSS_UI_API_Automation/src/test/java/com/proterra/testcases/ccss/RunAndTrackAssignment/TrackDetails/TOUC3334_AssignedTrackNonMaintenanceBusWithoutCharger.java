...
public class TOUC3334_AssignedTrackNonMaintenanceBusWithoutCharger extends BaseTestClass{
	...
	@Test(
			description="TOUC-3334: CCSS-RRT-Track Details: Assigned Track Details for Non Maintenance Bus in Non Charger Position",
	...
	public void Test_TOUC_3334() throws InterruptedException, IOException {
		...
		reportStep(Status.PASS, "The charger is not available at position "+chargerName);
