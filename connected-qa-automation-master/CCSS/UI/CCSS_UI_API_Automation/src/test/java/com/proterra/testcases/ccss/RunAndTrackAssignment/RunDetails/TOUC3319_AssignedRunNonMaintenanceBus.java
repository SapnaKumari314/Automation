...
public class TOUC3319_AssignedRunNonMaintenanceBus extends BaseTestClass{
	...
	@Test(
			description="TOUC-3319: CCSS-RRT-Run Details: Assigned Run Details for Non Maintenance Bus",
	...
	public void Test_TOUC_3319() throws InterruptedException {
		...
		sAssert.assertFalse(rrtPage.getBusMaintenanceStatus(), "Needs Maintenance is set to False");
		...
		sAssert.assertEquals(rrtPage.CCSS_RunDetailsComponentHeader.getText(), "Assigned Run", "Assigned Run Details Header");
		...
		sAssert.assertEquals(uiRunDetailsMap.get(rrtPage.RUN_STATUS), "Assigned", "Run Status for Recommended Run");
