...
public class TOUC3333_AssignedTrackNonMaintenanceBusWithCharger extends BaseTestClass{
	...
	@Test(
			description="TOUC-3333: CCSS-RRT-Track Details: Assigned Track Details for Non Maintenance Bus in Charger Position",
	...
	public void Test_TOUC_3333() throws InterruptedException, IOException {
		...
		sAssert.assertEquals(uiTrackDetailsMapAfterAssignment.get(rrtPage.TRACK_TYPE), "Charging", "Track Type Value for Charger Position");
